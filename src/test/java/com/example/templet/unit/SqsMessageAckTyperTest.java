/*
package com.example.templet.unit;

import com.amazonaws.services.lambda.runtime.events.SQSEvent;
import com.example.templet.conf.FacadeIT;
import com.example.templet.endpoint.event.EventConsumer;
...
public class SqsMessageAckTyperTest extends FacadeIT {
  ...
  void to_acknowledgeable_typed_event_ok() throws JsonProcessingException {
    ...
    var typedEvent =
        new EventConsumer.TypedEvent("com.example.templet.endpoint.event.gen.UuidCreated", payload);
