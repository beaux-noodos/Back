...
VALUES
    ('client1_id', 'Ryan', 'Andria', 'test@gmail.com', '01-01-1995', 'CLIENT', 'M', '2000-01-01T08:12:20.00z', '2021-11-08T08:25:24.00Z', 'client1_profile_key', 'client1_banner_key', 'username_client1', 'ENABLED'),
    ('client2_id', 'Herilala', 'Raf', 'hei.hajatiana@gmail.com', '01-01-2002', 'CLIENT', 'F', '2002-01-01T08:12:20.00z', '2020-11-08T08:25:24.00Z', null, null, 'username_client2', 'ENABLED'),
...
-- Insertion de données pour la table course_category
INSERT INTO course_category (id, creation_datetime, last_update_datetime, name, description)
VALUES
...
-- Insertion de données pour la table course
INSERT INTO course (id, creation_datetime, last_update_datetime, user_id, like_number, dislike_number, view_number, star_number, star_medium, title, description, course_status, image_key, price)
VALUES
    (UUID_GENERATE_V4(), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, (SELECT id FROM "user" WHERE mail = 'john.doe@example.com'), 30, 5, 300, 20, 4.6, 'Course 1', 'Description of Course 1', 'PLANNING', 'image1.jpg', 100.0),
    (UUID_GENERATE_V4(), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, (SELECT id FROM "user" WHERE mail = 'jane.smith@example.com'), 40, 2, 400, 25, 4.9, 'Course 2', 'Description of Course 2', 'IN_PROGRESS', 'image2.jpg', 200.0),
    (UUID_GENERATE_V4(), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, (SELECT id FROM "user" WHERE mail = 'alice.johnson@example.com'), 50, 3, 500, 30, 5.0, 'Course 3', 'Description of Course 3', 'COMPLETED', 'image3.jpg', 300.0);

-- Insertion de données pour la table course_reaction
INSERT INTO course_reaction (id, user_id, creation_datetime, last_update_datetime, like_reaction, vision, stars_number, comment, course_id)
VALUES
    (UUID_GENERATE_V4(), (SELECT id FROM "user" WHERE mail = 'john.doe@example.com'), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'LIKE', TRUE, 5, 'Excellent course!', (SELECT id FROM course WHERE title = 'Course 1')),
    (UUID_GENERATE_V4(), (SELECT id FROM "user" WHERE mail = 'jane.smith@example.com'), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'DISLIKE', FALSE, 2, 'Not satisfied.', (SELECT id FROM course WHERE title = 'Course 2')),
    (UUID_GENERATE_V4(), (SELECT id FROM "user" WHERE mail = 'alice.johnson@example.com'), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'LIKE', TRUE, 4, 'Very informative.', (SELECT id FROM course WHERE title = 'Course 3'));

-- Insertion de données pour la table course_followers
INSERT INTO course_followers (course_id, user_id)
VALUES
    ((SELECT id FROM course WHERE title = 'Course 1'), (SELECT id FROM "user" WHERE mail = 'john.doe@example.com')),
    ((SELECT id FROM course WHERE title = 'Course 2'), (SELECT id FROM "user" WHERE mail = 'jane.smith@example.com')),
    ((SELECT id FROM course WHERE title = 'Course 3'), (SELECT id FROM "user" WHERE mail = 'alice.johnson@example.com'));

-- Insertion de données pour la table course_interested
INSERT INTO course_interested (course_id, user_id)
VALUES
    ((SELECT id FROM course WHERE title = 'Course 1'), (SELECT id FROM "user" WHERE mail = 'jane.smith@example.com')),
    ((SELECT id FROM course WHERE title = 'Course 2'), (SELECT id FROM "user" WHERE mail = 'alice.johnson@example.com')),
    ((SELECT id FROM course WHERE title = 'Course 3'), (SELECT id FROM "user" WHERE mail = 'john.doe@example.com'));

-- Insertion de données pour la table course_session
INSERT INTO course_session (id, creation_datetime, last_update_datetime, course_id, location_id, like_number, dislike_number, view_number, star_number, star_medium, professor_id, title, description, start_datetime, end_datetime)
VALUES
    (UUID_GENERATE_V4(), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, (SELECT id FROM course WHERE title = 'Course 1'), (SELECT id FROM location WHERE name = 'Location 1'), 100, 10, 1000, 50, 4.8, (SELECT id FROM "user" WHERE mail = 'john.doe@example.com'), 'Session 1', 'Description of Session 1', CURRENT_TIMESTAMP + INTERVAL '7 days', CURRENT_TIMESTAMP + INTERVAL '14 days'),
    (UUID_GENERATE_V4(), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, (SELECT id FROM course WHERE title = 'Course 2'), (SELECT id FROM location WHERE name = 'Location 2'), 200, 15, 2000, 70, 4.9, (SELECT id FROM "user" WHERE mail = 'jane.smith@example.com'), 'Session 2', 'Description of Session 2', CURRENT_TIMESTAMP + INTERVAL '10 days', CURRENT_TIMESTAMP + INTERVAL '20 days'),
    (UUID_GENERATE_V4(), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, (SELECT id FROM course WHERE title = 'Course 3'), (SELECT id FROM location WHERE name = 'Location 3'), 150, 20, 1500, 60, 5.0, (SELECT id FROM "user" WHERE mail = 'alice.johnson@example.com'), 'Session 3', 'Description of Session 3', CURRENT_TIMESTAMP + INTERVAL '15 days', CURRENT_TIMESTAMP + INTERVAL '30 days');

-- Insertion de données pour la table course_session_reaction
INSERT INTO course_session_reaction (id, user_id, creation_datetime, last_update_datetime, like_reaction, vision, stars_number, comment, course_session_id)
VALUES
    (UUID_GENERATE_V4(), (SELECT id FROM "user" WHERE mail = 'john.doe@example.com'), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'LIKE', TRUE, 5, 'Amazing session!', (SELECT id FROM course_session WHERE title = 'Session 1')),
    (UUID_GENERATE_V4(), (SELECT id FROM "user" WHERE mail = 'jane.smith@example.com'), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'DISLIKE', FALSE, 3, 'Could be better.', (SELECT id FROM course_session WHERE title = 'Session 2')),
    (UUID_GENERATE_V4(), (SELECT id FROM "user" WHERE mail = 'alice.johnson@example.com'), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'LIKE', TRUE, 4, 'Good session.', (SELECT id FROM course_session WHERE title = 'Session 3'));

-- Insertion de données pour la table course_course_category
INSERT INTO course_course_category (course_id, course_category_id)
VALUES
    ((SELECT id FROM course WHERE title = 'Course 1'), (SELECT id FROM course_category WHERE name = 'Category 1')),
    ((SELECT id FROM course WHERE title = 'Course 2'), (SELECT id FROM course_category WHERE name = 'Category 2')),
    ((SELECT id FROM course WHERE title = 'Course 3'), (SELECT id FROM course_category WHERE name = 'Category 3'));
...
VALUES
    ...
    (UUID_GENERATE_V4(), (SELECT id FROM "user" WHERE mail = 'alice.johnson@example.com'), 'Can you guide me through the process?', 'Of course, let me explain step by step.', CURRENT_TIMESTAMP);
